<div id="modal-qty1-update<?php echo $row['temp_trans_id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form data-toggle="validator" method="post" action="queries/credit_transaction_update.php" enctype='multipart/form-data'>
