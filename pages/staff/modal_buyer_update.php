<div id="modal-buyer-update<?php echo $row['supplier_id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form data-toggle="validator" method="post" action="queries/buyer_update.php" enctype="multipart/form-data">
