                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php 
                                                        if ($row1['status'] == 'paid') 
                                                          echo "<span class='badge badge-success'>".$row1['status']."</span>";
                                                        else
                                                ...
                                                <td>
                                                    ...
                                                    <a href="credit_receipt_reprint.php?sid=<?php echo $row1['sales_id'];?>"><i class="glyphicon glyphicon-print"></i></a>
                                                    <a href="creditors_payment_schedule.php?sid=<?php echo $row1['sales_id'];?>&cid=<?php echo $row['cust_id'];?>"><i class="glyphicon glyphicon-list"></i></a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>       
                                        </tbody>
