...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <!-- ========================================= -->
                                <form data-toggle="validator" class="form-horizontal" method="post" action="queries/transaction_insert.php" enctype='multipart/form-data'>
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#modal-qty-update<?php echo $row['temp_trans_id'];?>" data-target="#modal-qty-update<?php echo $row['temp_trans_id'];?>" data-toggle="modal" class="btn btn-outline-success waves-effect waves-light" onclick="return confirm('Update Quantity?')"><i class="glyphicon glyphicon-edit text-success" data-toggle="tooltip" data-placement="top" title="Update Quantity"></i></a>
                                                    <?php include('modal_qty_update.php'); ?>
                                                    
                                                    <a href="#modal-trans-delete<?php echo $row['temp_trans_id'];?>" data-target="#modal-trans-delete<?php echo $row['temp_trans_id'];?>" data-toggle="modal"class="btn btn-outline-danger waves-effect waves-light" onclick="return confirm('Remove to cart?')"><i class="glyphicon glyphicon-trash text-danger" data-toggle="tooltip" data-placement="top" title="Remove to cart."></i></a>
                                                    <?php include('modal_transaction_delete.php'); ?>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>      
                                        </tbody>
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <!-- Form for payment-->
                                <!-- ========================================= -->
                                <form name="autoSumForm" method="post" action="queries/sales_insert.php" enctype='multipart/form-data'>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" style="text-align:right" class="form-control" id="total" name="total" placeholder="Total" 
                                                    value="<?php echo $grand;?>" onFocus="startCalc();" onBlur="stopCalc();" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="date">Discount</label>
                                                <input type="text" class="form-control text-right" id="discount" name="discount" value="0" placeholder="Discount (Php)" onFocus="startCalc();" onBlur="stopCalc();">
                                            </div>
                                            <div class="form-group">
        ...
        <?php 
            include('components/autosum.php'); 
