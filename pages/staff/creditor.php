                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Creditor</h4>
                        </div>
                        <!-- ========================================= -->
                        <!-- /.Page Title -->
                        <!-- ========================================= -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="button-box">
                                ...
                                <i class="fa fa-plus-circle" data-toggle="tooltip" data-placement="top" title="Add Supplier"></i> Add New Creditor</button>
                                    ...
                                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" data-target="#modal-creditor-update<?php echo $cid;?>" data-toggle="modal" style="color:#fff;" class="btn btn-outline-success waves-effect waves-light" onclick="return confirm('Update this data?')">
                                                    <i class="glyphicon glyphicon-edit text-blue" data-toggle="tooltip" data-placement="top" title="Update Buyer Details"></i>
                                                    </a>
                                                    <?php include('modal_creditor_update.php'); ?>
                                                    <a href="<?php if ($row['credit_status'] == 'Approved') echo "account_summary.php?cid=$cid";?>" class="btn btn-outline-success waves-effect waves-light">
